...
# ╔═╡ d89c653d-e82f-4595-a1b9-7f41bb12e770
...
# ╔═╡ 74d83bf7-85ec-4cfb-a0cb-045b236ccf1a
middict = begin
	loadem
	tomldict(joinpath(pwd(), "MID.toml"))
end

# ╔═╡ 871e40d4-28d8-40e4-ae16-8351384ec80f
parsefile = join([middict["projectshort"], "-parses.cex"])

# ╔═╡ d79729a1-5f89-4f1b-9fc0-95f238005868
tkns = begin
	loadem
	f = joinpath(dirname(pwd()), "morphology", parsefile)
...
git-tree-sha1 = "90f615aa47d2f7dac29de5189c55daaae73d6ceb"
...
git-tree-sha1 = "419a99568752e5bc0ce02a160ed0720091b8f6c8"
...
git-tree-sha1 = "f5408ce44bf228258a221f4fd3f49574206e7bc3"
